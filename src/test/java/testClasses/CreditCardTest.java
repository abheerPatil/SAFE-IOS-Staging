...
public class CreditCardTest {
	...
	public void addCreditCard(String one, String two, String three, String four, String cardNum, String expiry, String cvv, String name, String zip){
		try{
			...
			ob6.addCredentials(cardNum, expiry, cvv, name, zip);
